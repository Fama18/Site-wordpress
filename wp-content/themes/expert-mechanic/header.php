					...
					<div class="row">
						<div class="offset-lg-1 col-lg-6 col-md-7">
							<?php if(get_theme_mod('expert_mechanic_email') != '') { ?>
								<span class="email"><?php echo esc_html(get_theme_mod('expert_mechanic_email')); ?></span>
							<?php } ?>
							<?php if(get_theme_mod('expert_mechanic_call') != '') { ?>
								<span class="call"><?php echo esc_html(get_theme_mod('expert_mechanic_call')); ?></span>
							<?php } ?>
						</div>
							...
							<div class="col-lg-8 col-md-5 col-6">
								<div class="menu-section">
									<div class="toggle-menu responsive-menu">
							            <button onclick="expert_mechanic_open()" role="tab" class="mobiletoggle"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','expert-mechanic'); ?></span></button>
							        </div>
