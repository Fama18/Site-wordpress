				      	...
				      	<?php  while ( $query->have_posts() ) : $query->the_post(); ?>
					        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
					          	...
					          	<div class="carousel-caption">
						            ...
						            <div class="read-btn">
					            		<a href="<?php esc_url(the_permalink());?>"><?php esc_html_e('READ MORE','expert-mechanic'); ?><span class="screen-reader-text"><?php esc_html_e('READ MORE','expert-mechanic'); ?></span></a>
							       	</div>
					          	</div>
					        </div>
				      	<?php $i++; endwhile; 
